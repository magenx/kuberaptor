...
This security policy applies to public projects under the [magenx organization][gh-organization] on GitHub.

## Security/Bugfix Versions

Security and bug fixes are generally provided only for the latest version.
...
If you are absolutely unable to or have strong reasons not to use GitHub's vulnerability reporting workflow, please reach out to the MagenX security team at [admin@magenx.com](mailto:admin@magenx.com).

[gh-organization]: https://github.com/magenx
